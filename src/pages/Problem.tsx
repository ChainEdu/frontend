  ...
  return (
    <Card>
      ...
      <Grid
          ...
          sm={5}
          xs={12}
          sx={{ paddingTop: ['0 !important', '1.5rem !important'], paddingRight: ['1.5rem !important', '0 !important'] ,backgroundColor: '#2a9d8f'}}
        >
          <CardContent
        ...
        <Grid item xs={12} sm={7} sx={{backgroundColor: '#2a9d8f'}} >
