    ...
    <Card>
      <Grid container spacing={6}>
        <Grid item xs={12} sm={7}>
          <CardContent sx={{ backgroundColor: '#2a9d8f', padding: theme => `${theme.spacing(3.25, 5.75, 6.25)} !important` }}>
            ...
            <Grid container spacing={4}>
              <Grid item xs={12} sm={5}>
                <StyledBox>
                  <Box sx={{ mb: 8.75, display: 'flex', alignItems: 'center' }}>
                    <Login/>
                  </Box>
                </StyledBox>
              </Grid>
        ...
        <Grid
          ...
          sm={5}
          xs={12}
          sx={{ backgroundColor: '#2a9d8f', paddingTop: ['0 !important', '1.5rem !important'], paddingLeft: ['1.5rem !important', '0 !important'] }}
        >
          <CardContent
          ...
          >
            <Box>
              ...
              <Img  height= '400' width='500' alt='TOC Logo' src='/images/misc/animation.png' />
              </Box>
